...
class ProxyOrderMigrationService implements ProxyOrderMigrationServiceInterface
{
    ...
    function migrate()
    {
        ...
        $this->migration->withTable('proxy_orders')
            ...
            ->field('batch_id')->definition('INT NOT NULL')->run()
            ->field('agent_id')->definition('INT NOT NULL')->run()
            ...
            ->field('screen_shot1')->definition('VARCHAR(255)')->run()
            ->field('screen_shot2')->definition('VARCHAR(255)')->run()
            ->field('screen_shot3')->definition('VARCHAR(255)')->run()
            ...
            ->field('total_amount_usd')->definition('VARCHAR(255) NOT NULL')->run()
            ->field('grand_total_naira')->definition('VARCHAR(255) NOT NULL')->run()
            ->field('shipping_cost_usd')->definition('FLOAT NOT NULL')->run()
            ->field('dollar_to_naira_rate')->definition('FLOAT NOT NULL')->run()
