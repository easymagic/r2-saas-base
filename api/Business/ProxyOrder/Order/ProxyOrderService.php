...
class ProxyOrderService implements ProxyOrderServiceInterface
{
    ...
    private ProxyOrderMigrationRepositoryInterface $proxyOrderMigrationRepository;
    ...
    public function __construct(
        ...
        ProxyOrderMigrationRepositoryInterface $proxyOrderMigrationRepository,
        ...
        $this->proxyOrderMigrationRepository = $proxyOrderMigrationRepository;
    ...
    public function create(
        ...
        if (!in_array($type, ProxyOrderRepositoryInterface::ALLOWED_TYPES)) {
    ...
    public function updateStatus(int $id, string $status)
    {
        ...
        if (!in_array($status, ProxyOrderRepositoryInterface::ALLOWED_STATUSES)) {
    ...
    function migrate()
    {
        $this->proxyOrderMigrationRepository->migrate();
    }
