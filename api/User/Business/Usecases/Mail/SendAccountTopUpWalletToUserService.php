...
class SendAccountTopUpWalletToUserService
{
    ...
    public function execute(int $accountId, float $amount)
    {
        ...
        $body = $this->baseMailTheme->wrapTemplate(
            ...
            . $this->accountMailTemplate->intro('Your wallet has been credited successfully.')
            . $this->accountMailTemplate->amountBox('Amount credited', $amount, true)
