...
class NotifyCustomerOfStatusChangeService
{
    ...
    public function execute(int $order_id, string $status)
    {
        ...
        $body = $this->baseMailTheme->wrapTemplate(
            ...
            . $this->snappyOrderMailTemplate->intro('Your order status has been updated.')
            . $this->snappyOrderMailTemplate->statusBanner('New status', $status)
